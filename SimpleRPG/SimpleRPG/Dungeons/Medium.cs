...
namespace SimpleRPG
{
    class Medium
    {
        ...
        public void Setup()
        {
            ...
            NextLevelExp = 350;
            Console.Clear();
            Console.WriteLine("You Have Chosen the Medium Dungeon. You Have Some Balls At Least.");
            Console.ReadLine();
            Console.Write("In This Dungeon You Must Move 20 Spaces to Win! Battles are more Common and More Difficult!");
            Console.ReadLine();
            Console.Write("\nEnter Your Name: ");
        ...
        public void BeginDunegon()
        {
            ...
            if (DungeonPosition > 19)
            {
                Success();
                return;
            }

            else if (DungeonPosition < 20)
            {
                Console.Clear();
